...
# 
# Vamos sortear as bolas e devolvendo elas para a bolsa novamente. Em três sorteios, tiver o seguinte resultado:
# 
# $$[Azul, Branca, Azul]$$
# 
...
sample = [1, 0, 1]  # Nossa retirada


# In[3]:


# Contaremos quantas vezes cada hipótese pode ter ocorrido.

plausibilidade_da_hipotese = {}  # Inicializando um novo dicionário com as hipóteses propostas.

plausibilidade_da_hipotese['B B B B'] = 0  # 4 * 0 * 4  = Nenhuma configuraçao possível
...
plausibilidade_da_hipotese['A A A A'] = 0  # 4 * 0 * 4  = Nenhuma configuraçao possível


# ----
# 
# *Esse o cerne da estatística bayesiana, apenas contagens!*
# 
# ----

# Uma das coisas interessantes que podemos fazer é usar a contagem anterior (priori), e somar com a contagem atual:
# 
# Digamos que retiramos mais uma bola, dessa vez Azul:
# $$[A]$$
# 
...
# Python Code 2.1 - Statistical Rethiking
ways = np.array([3, 8, 9])
print(ways/sum(ways))
