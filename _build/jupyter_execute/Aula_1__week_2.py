...
# ----
# 
# ## *Engenharia de Golems*

# Para esse capítulo teremos dois objetivos:
#     
#     1. Dar uma intuição em como a atualização funciona. Como os Golems aprendem com a experiência.
#     
...
# <img src="./images/earth.jpg" width=600 height=600>
...
# <img src="./images/casuality_proportional_water.png" width=30% heigth=30% />
# 
...
#  
# 
# <img src="./images/mark_recapture.jpeg" width=40% height=40%>
# 
...
stats.binom.pmf(6, n=9, p=0.5)  # pmf = Probability Mass Function
...
ax[0, 1].plot(p_s, verossimilhanca / sum(verossimilhanca), color='blue')  # Plot da Verossimilhanca.

posteriori = verossimilhanca * priori # Calculando a posteriori
ax[0, 2].plot(p_s, posteriori / sum(posteriori), color='blue')  # Plot da Posteriori
...
ax[1, 1].plot(p_s, verossimilhanca / sum(verossimilhanca), color='blue')  # Plot da Verossimilhanca.

posteriori = verossimilhanca * priori # Calculando a posteriori
ax[1, 2].plot(p_s, posteriori / sum(posteriori), color='blue')  # Plot da Posteriori
...
ax[2, 1].plot(p_s, verossimilhanca / sum(verossimilhanca), color='blue')  # Plot da Verossimilhanca.

posteriori = verossimilhanca * priori # Calculando a posteriori
ax[2, 2].plot(p_s, posteriori / sum(posteriori), color='blue')  # Plot da Posteriori
...
max_posteriori = max(posteriori) / 2  # Proposta de um tamanho da barra horizontal

# Plotando 3 pontos verticais
plt.vlines(0.3, 0, max_posteriori, color='red', ls='--', lw=5)  # Ponto 1
plt.vlines(0.5, 0, max_posteriori, color='orange', ls='--', lw=5)  # Ponto 2
plt.vlines(0.9, 0, max_posteriori, color='green', ls='--', lw=5)  # Ponto 3
